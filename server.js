...
async function syncNotary() {
  try {
    ...
    // ALIGNMENT: Use b"notary" seed to match lib.rs
    ...
    // ALIGNMENT: Account names must match lib.rs struct exactly
    const tx = await program.methods
      .updateIntegrity(giniScore, hhiScore, status)
      .accounts({
        notaryAccount: userIntegrityPda, // Match lib.rs
        notary: NOTARY_KEYPAIR.publicKey,
        targetUser: TARGET_WALLET,      // Match lib.rs
